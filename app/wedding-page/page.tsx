  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#5b1e2a_0%,#2d0d15_32%,#12070d_100%)] px-6 py-12 text-[#f7e5b8] md:px-10 md:py-20">
      <div className="mx-auto max-w-5xl rounded-[32px] border border-[#8a4f5d]/60 bg-[linear-gradient(135deg,rgba(53,18,23,0.96),rgba(90,23,30,0.92),rgba(47,14,18,0.98))] p-6 shadow-[0_30px_120px_rgba(26,8,12,0.72)] md:p-10">
        ...
        <p className="mt-8 text-center font-mono text-[11px] font-medium uppercase tracking-[0.28em] text-[#f5d77a]">Wedding Celebration</p>
        <h1 className="mt-6 text-center bg-gradient-to-r from-[#f9e6b1] via-[#d8b96d] to-[#f3d479] bg-clip-text font-display text-[clamp(40px,7vw,72px)] font-black leading-[0.96] tracking-[-0.06em] text-transparent">
          Amisha &amp; Shreyas
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-center text-base text-[#f1d7a0] md:text-lg">
